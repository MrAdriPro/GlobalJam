...
public class M_ToggleSwitch : MonoBehaviour, IPointerClickHandler
{
    [Header("Slider setup")]
    ...
    private M_ToggleSwitchGroupManager _toggleSwitchGroupManager;
    ...
    public void SetupForManager(M_ToggleSwitchGroupManager manager)
    {
    ...
    public void UpdateCurrentValue(bool value)
    {
    ...
    private void SetStateAndStartAnimation(bool state)
    {
        ...
        print("Previous Value" + _previousValue);
